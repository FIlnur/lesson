...
// 17. Напиши функцию, которая принимает число и с помощью
// цикла выводит в консоль все четные числа от единицы до этого числа.
...
// 18. Напиши функцию, которая принимает стартовое число и
// циклом выводит в консоль обратный отсчет от него до нуля.

// 19. Напиши функцию, которая принимает число и циклом считает сумму
// всех целых чисел от единицы до заданного, а затем возвращает итог.
